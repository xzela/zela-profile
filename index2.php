...
<html lang="en">
  <head>
    ...
    <!-- Loading Bootstrap -->
    <link href="/css/third-party/bootstrap/bootstrap.css" rel="stylesheet">
    ...
    <!--[if lt IE 9]>
      <script src="js/third-party/html5shiv/html5shiv.js"></script>
      <script src="js/third-party/respond/respond.min.js"></script>
    <![endif]-->
  </head>
  <body>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav">
                    ...
                    <li><a href="https://github.com/xzela"><span class="fa fa-github"></span> Github</a></li>
    ...
    <div class="container">
        <div class="page-header profile-header">
            <h1 class="">Zeph LaFassett <small> - a kick ass web developer!</small></h1>
        </div>
        <div class="container container-project lang">
            <div class="row">
                <div class="col-md-6">
                    <h3>Lang Antiques</h3>
                ...
                <div class="col-md-6">
                    <img class="img-responsive" src='images/screenshots/langantiques.png' alt='Lang Antiques screenshot' title='click here to buy some antique jewelry'/>
                </div>
            </div>
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div>
                        ...
                        <span class="label label-default">CodeIgntiter</span>
                        <span class="label label-default">MySQL</span>
                        <span class="label label-default">APC</span>
                        <span class="label label-default">PHP-GD</span>
                        <span class="label label-default">CSS</span>
                        <span class="label label-default">SEO</span>
                        <span class="label label-default">awesome jewelry!</span>
                    </div>
                </div>
            </div>
        </div>
        <div class="container container-project">
            <div class="row">
                ...
                <div class"=col-md-6">
                    <img class="img-responsive" src='images/screenshots/cardr.png' alt='Cardr - The Credit Card Monitoring Service' title="Don't be fooled" />
                </div>
            </div>
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div>
                        ...
                        <span class="label label-default">SSL</span>
                        <span class="label label-default">Grunt</span>
                        <span class="label label-default">fake site</span>
                        <span class="label label-default">does not steal credit card information</span>
                    </div>
                </div>
            </div>
        </div>
    ...
    <script src="/js/third-party/jquery/jquery-1.8.3.min.js"></script>
